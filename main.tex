...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Software}\hspace{1.6cm}{Jupyter Notebook, PyCharm, RStudio, Processing, Eclipse}
    }}
 \end{itemize}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        % \resumeItem{Project involved integration of functionalities to several thousand lines of code in RoboCup Rescue simulator}
        \resumeItem{Built a model using Proximal Policy Optimization (PPO) and Deep Q-networks (DQN) using OpenAI’s Gym on different sized maps that accomplished tasks in 18\% lesser time compared to previous best model \href{https://towardsdatascience.com/multiagent-reinforcement-learning-for-robocup-rescue-simulator-17773553f46}{(Link)}}
        \vspace{0.5in}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Wrote SQL queries to extract CAD models and identify cost drivers in machine component design}
